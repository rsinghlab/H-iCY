...
def evaluate(result_name, 
    ...
    for idx, upscaled_chromosome_file in enumerate(upscaled_chromosome_files):
        ...
        if 'insulation_score' in steps:
            print("Running Insulation Score analysis on experiment: {}...".format(experiment_names[idx]))
            analysis_results = ''
            analysis_results += downstream_analysis.compute_insulation_score_on_experiment_directory(
                target_chromosome_file,
                upscaled_chromosome_file,
                experiment_names[idx],
                base_cutoff=upscaled_cutoffs[idx],
